...
public final class Field {
  ...
  public static final String CUSTOMFIELD_HHTEAM = "customfield_10055";
   ...
   *
   * @throws JiraException                 when a value is bad or field has
   *                                       invalid metadata
  ...
  public static Object toJson(String name, Object value, JSONObject editmeta)
    ...
    if (m.type.equals("array")) {
      ...
      return json.toString();
        ...
        || (m.type.equals("securitylevel") || m.type.equals("option"))) {
      if (value == null)
        return "";
