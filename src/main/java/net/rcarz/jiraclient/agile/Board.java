...
public class Board extends AgileResource {
  ...
  public List<Sprint> getActiveSprints() throws JiraException {
    return Sprint.getAllActiveSprint(getRestclient(), getId());
  }
  ...
  public List<Issue> getBacklog() throws JiraException {
    return AgileResource.list(getRestclient(), Issue.class,
        RESOURCE_URI + "board/" + getId() + "/backlog", "issues");
  }
  ...
  public List<Issue> getIssuesWithoutEpic() throws JiraException {
    return AgileResource.list(getRestclient(), Issue.class,
        RESOURCE_URI + "board/" + getId() + "/epic/none/issue", "issues");
  }
  ...
  public List<Epic> getEpics() throws JiraException {
    return AgileResource.list(getRestclient(), Epic.class,
